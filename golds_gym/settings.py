"""
Django settings for golds_gym project.
...
WSGI_APPLICATION = 'golds_gym.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'golds-gym'
...
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = 'goldsgym@example.com'
else:
